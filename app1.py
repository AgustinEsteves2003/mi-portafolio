...
with col1:
    ...
    st.write("El modelo es un XGBoost con un Recall del 82% que busca detectar aquellos clientes que dejaran el servicio para que la empresa haga un esfuerzo por retenerlos.")
...
with col2:
    ...
    st.write("Creado a modo de trabajo final para la materia Big Data & Machine Learning de la facultad, este modelo de Random Forests con un Recall del 84% "
             "que busca predecir la probabilidad de impago de la tarjeta de credito del cliente el proximo mes.")
